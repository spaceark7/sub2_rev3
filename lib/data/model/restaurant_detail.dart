...
class Detail {
    ...
    factory Detail.fromJson(Map<String, dynamic> json) => Detail(
        ...
        customerReviews: List<CustomerReview>.from((json["customerReviews"] as List).map((x) => CustomerReview.fromJson(x)).where((element) => element.name != null && element.review != null && element.date != null)),
    );
